...
abstract class S {
  ...
  /// No description provided for @ftShort.
  ///
  /// In en, this message translates to:
  /// **'FT'**
  String get ftShort;
  ...
  /// No description provided for @nottinghamForest.
  ///
  /// In en, this message translates to:
  /// **'Nottingham Forest'**
  String get nottinghamForest;

  /// No description provided for @manUnited.
  ///
  /// In en, this message translates to:
  /// **'Manchester United'**
  String get manUnited;
}
